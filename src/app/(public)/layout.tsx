...
export default function PublicLayout({
  ...
  // If user is authenticated, use the full Navigation component
  if (session) {
    return (
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <a
                ...
                className="text-gray-600 dark:text-gray-300 hover:text-garden-600 dark:hover:text-garden-400 transition-colors flex items-center gap-1"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/donate" className="text-gray-500 dark:text-gray-400 hover:text-garden-600 dark:hover:text-garden-400">
                    Support the Project
                  </Link>
                </li>
                <li>
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-500 dark:text-gray-400 hover:text-garden-600 dark:hover:text-garden-400 flex items-center gap-1"
                  >
