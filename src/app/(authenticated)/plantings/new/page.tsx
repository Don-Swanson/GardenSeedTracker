...
function getSeedDisplayName(seed: Seed): string {
  return seed.plantType?.name || seed.customPlantName || seed.nickname || 'Unknown Seed'
}
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
          ...
          >
            ...
            {seeds.map(seed => (
              <option key={seed.id} value={seed.id}>
                {getSeedDisplayName(seed)}{seed.variety ? ` (${seed.variety})` : ''}
              </option>
            ))}
          </select>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
