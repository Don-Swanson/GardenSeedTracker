...
export async function POST(
  ...
  try {
    ...
    notifyAdmins('newPlantSuggestion', {
      plantName: plant.name,
      userEmail: anonymizedEmail || undefined,
      userName: anonymizedName,
      additionalInfo: { section, suggestionType },
    }).catch(err => console.error('Failed to notify admins of suggestion:', err))
