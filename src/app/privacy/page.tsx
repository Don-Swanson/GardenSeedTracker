      ...
      <div className="prose prose-garden max-w-none space-y-6">
        <section>
          ...
          <div className="text-gray-700 space-y-3">
            ...
            <p>
              <strong>1.3 Payment Information:</strong> Payment processing is handled entirely by Square. 
              We do not store credit card numbers or sensitive payment details on our servers. We only 
              store a reference ID to your Square customer profile.
            </p>
            <p>
              <strong>1.4 Usage Data:</strong> We may collect information about how you use the Service, 
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>To send renewal reminders and service-related communications</li>
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            no method of transmission over the Internet is 100% secure. Payment processing is handled 
            by Square, a PCI-DSS compliant payment processor, ensuring your financial information is 
            protected.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            We retain your data as described in our Terms of Service. For expired subscriptions, we 
            typically retain Pro feature data for up to one year before it may be removed. You can 
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>Export your data (available to paid subscribers)</li>
