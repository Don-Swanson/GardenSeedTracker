...
async function handleUpdate(
  ...
  try {
    ...
    const finalCustomPlantName = data.plantTypeId ? null : data.customPlantName
    const finalCustomCategory = data.plantTypeId ? null : data.customCategory
    ...
    const seed = await prisma.seed.update({
      ...
      data: {
        ...
        // Planting reminders
        enableIndoorStartReminder: data.enableIndoorStartReminder ?? existing.enableIndoorStartReminder,
        enableDirectSowReminder: data.enableDirectSowReminder ?? existing.enableDirectSowReminder,
        enableTransplantReminder: data.enableTransplantReminder ?? existing.enableTransplantReminder,
      },
