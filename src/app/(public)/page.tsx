    ...
    <div className="space-y-20 pb-16">
      ...
      <section className="relative pt-8 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/plants"
              className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-lg font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border border-gray-200 dark:border-gray-700"
            >
      ...
      <section className="bg-garden-600 dark:bg-garden-700 rounded-2xl p-8 md:p-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/pricing"
            className="px-8 py-4 bg-garden-700 dark:bg-garden-800 text-white text-lg font-semibold rounded-xl hover:bg-garden-800 dark:hover:bg-garden-900 transition-colors border border-garden-500"
          >
            View Pricing
          </Link>
        </div>
